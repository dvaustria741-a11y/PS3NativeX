...
// package changed and adapted against our own RemoteGpuDriver (see
// GpuDriverCatalogRepository.kt) and MobileSocNameMapper.kt ports;
// otherwise unmodified -- this is the SoC->Adreno family mapping table
// EmuCoreC's own "Driver catalog" screen uses for its "Best match" badges.
...
/** Maps the detected Snapdragon SoC to the Adreno families used by driver packages. */
